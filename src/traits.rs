...
use std::ops::{Shl, Shr};
use num_traits::{Num, PrimInt, WrappingAdd, WrappingMul, WrappingShl, WrappingShr, WrappingSub};
use crate::int::big_int::BigInt;
...
pub trait Integral: Num + Shl<usize, Output = Self> + Shr<usize, Output = Self> {}
...
/// This is automatically implemented for types which implement the traits.
pub trait WrappingOps: WrappingAdd + WrappingSub + WrappingMul + WrappingShl + WrappingShr {}

impl<T> WrappingOps for T
where
    T: WrappingAdd + WrappingSub + WrappingMul + WrappingShl + WrappingShr
{}
