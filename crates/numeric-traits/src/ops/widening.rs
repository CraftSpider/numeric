...
impl WideningMul for u8 {
    fn widening_mul(self, rhs: u8, add: u8) -> (u8, u8) {
        let wide = (self as u16).wrapping_mul(rhs as u16).wrapping_add(add as u16);
...
impl WideningMul for u16 {
    fn widening_mul(self, rhs: u16, add: u16) -> (u16, u16) {
        let wide = (self as u32).wrapping_mul(rhs as u32).wrapping_add(add as u32);
...
impl WideningMul for u32 {
    fn widening_mul(self, rhs: u32, add: u32) -> (u32, u32) {
        let wide = (self as u64).wrapping_mul(rhs as u64).wrapping_add(add as u64);
