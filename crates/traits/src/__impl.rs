...
macro_rules! impl_uint {
    ($ty:ty) => {
        ...
        impl crate::ops::Factorial for $ty {
            type Output = $ty;
...
macro_rules! impl_float {
    ($ty:ty) => {
        ...
        saturating_as!($ty, u64);
        saturating_as!($ty, u128);
        saturating_as!($ty, usize);

        saturating_as!($ty, i8);
        saturating_as!($ty, i16);
        saturating_as!($ty, i32);
        saturating_as!($ty, i64);
