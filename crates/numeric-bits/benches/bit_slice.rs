...
pub fn bench_sub(c: &mut Criterion) {
    bench_common(c, MathMeths {
        tr: "ElementSub",
        name: "sub",
        big_bit: |l, r| BitwiseOps::sub(l, r).0,
...
pub fn bench_div(c: &mut Criterion) {
    bench_common(c, MathMeths {
        tr: "ElementDiv",
        name: "div",
        big_bit: |l, r| BitwiseOps::div_long(l, r).0,
...
pub fn bench_shl(c: &mut Criterion) {
    ...
    c.benchmark_group("BitSlice::shl*")
        .bench_with_input(
            ...
            one,
            |b, one| {
                b.iter(|| BitwiseOps::shl(black_box(one), black_box(1)))
            })
        .bench_with_input(
            BenchmarkId::new("shl_bitwise", "[usize::MAX], 1"),
            max,
            |b, max| {
                b.iter(|| BitwiseOps::shl(black_box(max), black_box(1)))
            })
        .bench_with_input(
        ...
        .bench_with_input(
            ...
            one,
            |b, one| {
                b.iter(|| ElementShl::shl_wrap_and_mask_checked(black_box(&mut [1usize]), black_box(1)))
            })
        .bench_with_input(
            BenchmarkId::new("shl_wrap_and_mask_checked", "[usize::MAX], 1"),
            max,
            |b, max| {
                b.iter(|| ElementShl::shl_wrap_and_mask_checked(black_box(&mut [usize::MAX]), black_box(1)))
            })
        .bench_with_input(
            BenchmarkId::new("shl_wrap_and_mask_wrapping", "[1], 1"),
            one,
            |b, one| {
                b.iter(|| ElementShl::shl_wrap_and_mask_wrapping(black_box(&mut [1usize]), black_box(1)))
            })
        .bench_with_input(
            BenchmarkId::new("shl_wrap_and_mask_wrapping", "[usize::MAX], 1"),
            max,
            |b, max| {
                b.iter(|| ElementShl::shl_wrap_and_mask_wrapping(black_box(&mut [usize::MAX]), black_box(1)))
            });
     */
}
